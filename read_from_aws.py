...
spark = (
        ...
        # .config('fs.s3a.access.key',"XXXXXXXXXXXXXXXXXXXX")
        # .config('fs.s3a.secret.key', "XXXXXXXXXXXXXXXX")
        .getOrCreate()
)
...
#hadoop_conf.set("fs.s3a.access.key", "XXXXXXXXXXXXXXXXXXXXXXX")
#hadoop_conf.set("fs.s3a.secret.key", "XXXXXXXXXXXXXXXXXXXXXXXX")
